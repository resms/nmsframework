...
public class RSAUtils
{
     ...
     * 算法名称
     */
    protected static final String ALGORITHOM = "RSA";
     ...
     * 保存生成的密钥对的文件名称。
     */
    protected static final String RSA_PAIR_FILENAME = "__RSA_PAIR.txt";
    /**
     * 密钥大小
     */
     ...
     * 默认的安全服务提供者
     */
    //protected static final Provider DEFAULT_PROVIDER = new BouncyCastleProvider();

    protected static KeyPairGenerator keyPairGen = null;
    protected static KeyFactory keyFactory = null;
    /**
     * 缓存的密钥对。
     */
    protected static KeyPair oneKeyPair = null;

    protected static File rsaPairFile = null;
     ...
     * 生成并返回RSA密钥对。
     */
    protected static synchronized KeyPair generateKeyPair()
    {
        try
        {
     ...
     * 返回生成/读取的密钥对文件的路径。
     */
    protected static String getRSAPairFilePath()
    {
//        String urlPath = RSAUtils.class.getResource("/").getPath();
//        String p = (new File(urlPath).getParent() + File.separator + RSA_PAIR_FILENAME);
        String p = System.getProperty("user.dir") + File.separator + RSA_PAIR_FILENAME;
     ...
     */
    protected static boolean isCreateKeyPairFile()
    {
        // 是否创建新的密钥对文件
     ...
     */
    protected static void saveKeyPair(KeyPair keyPair)
    {
    ...
    // 同步读出保存的密钥对
    protected static KeyPair readKeyPair()
    {
...
//        System.out.println("原文比较：" + Arrays.equals(result2, plain));
        ...
        String originText = "我爱你中国";
        System.out.println(System.getProperty("user.dir"));
        System.out.println(RSAUtils.getRSAPairFilePath());
        System.out.println("origin Text:"+ originText);
        String encText = RSAUtils.encryptString(originText);
        System.out.println("encrypt text:"+encText);
        String decText = RSAUtils.decryptString(encText);
        System.out.println("decrypt text:"+decText);
        System.out.println(originText.equals(decText));
    }
}