...
{
	private static final String base62String = "ABC0DEFG1HIJKL2MNOP3QRS4TUVW5XYZabcdef6ghijk8lmno7pqr9stuvwxyz";
	...
	public static String getRandomStr()
	{
		...
		for(int i = 0;i < 16;i++)
		{
			int number = random.nextInt(base62String.length());
			sb.append(base62String.charAt(number));
		}
		return sb.toString();
	}
	...
	public static String getRandomToken()
	{
		...
		while(randomLen < 17)
		{
			randomLen = random.nextInt(base62String.length());
		}
	...
	public static String getRandomEncodingAesKey()
	{
		...
		// String base64String = Base64.encodeBase64URLSafeString(aesKeyBytes);
